...
import "./Modal.css";
import service8 from '../assets/email-mark.jpeg';
        ...
        <>
            <div onClick={toggleModal} className="rounded-2xl block relative img-bg">
                ...
                <div className="absolute left-0 top-0 bottom-0 right-0 flex flex-col items-center justify-end opacity-90 h-full w-full rounded-2xl ">
                    <div className=" border-2 border-white p-2 rounded-xl text-center mb-3 service-card bg-blck">
                        <p className="text-xl sm:text-xl md:text-xl lg:text-xl xl:text-xl font-bold text-white">
                            E-MAIL MARKETING
                        </p>
                        <p className="text-xs sm:text-xs md:text-xs lg:text-xs xl:text-xs font-bold text-white ">
                            CLICK TO BOOK
                        </p>
                    </div>
                </div>
