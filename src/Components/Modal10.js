...
// import service1 from '../images/service_1.jpeg';
...
return (
<>
<div onClick={toggleModal} className="rounded-2xl relative text-center inline-flex text-white gap-2 font-semibold hover:text-orange transition-all duration-300 ease-in cursor-pointer">
    {/* <div className="relative w-full">
        <img src={service1} alt="" className="rounded-2xl w-full" />
        ...
        <div className="absolute top-1/3 left-4 right-0 flex items-center">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-xl xl:text-xl font-bold text-white ml-3">UI/UX Designing</h2>
        </div>
    </div> */}
    <div className="flex items-center border border-white p-3 rounded-xl">
